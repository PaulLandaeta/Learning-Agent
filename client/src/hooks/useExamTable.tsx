...
import { theme, message, Button,  Tag, Tooltip, Typography, Space, Popconfirm, Dropdown } from 'antd';
...
export function StatusVisibility({ exam }: { exam: ExamSummary }) {
...
export function loadPrintableExam(exam: ExamSummary): PrintableExam | null {
...
export function handleDownloadPdf(exam: ExamSummary, mode: PrintMode) {
...
interface UseExamTableProps {
  onDelete?: (id: string) => Promise<void> | void;
  disableStatusControls?: boolean;
}

export const useExamTable = ({ onDelete, disableStatusControls = true }: UseExamTableProps) => {
